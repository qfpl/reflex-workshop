...
exAttributes =
  let
    problem =
      Problem
        "pages/dom/elements/attributes.html"
    ...
    solution =
      Solution [
        "pages/dom/elements/attributes/solution/0.html"
      , "pages/dom/elements/attributes/solution/1.html"
      , "pages/dom/elements/attributes/solution/2.html"
      , "pages/dom/elements/attributes/solution/3.html"
      ]
  in
    Exercise
      "attributes"
