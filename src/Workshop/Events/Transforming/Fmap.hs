...
exFmap =
  let
    problem =
      Problem
        "pages/events/transforming/fmap.html"
    ...
    solution =
      Solution [
        "pages/events/transforming/fmap/solution/0.html"
      , "pages/events/transforming/fmap/solution/1.html"
      , "pages/events/transforming/fmap/solution/2.html"
      , "pages/events/transforming/fmap/solution/3.html"
      ]
  in
    Exercise
      "fmap"
