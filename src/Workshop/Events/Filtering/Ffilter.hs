...
exFfilter =
  let
    problem =
      Problem
        "pages/events/filtering/ffilter.html"
    ...
    solution =
      Solution [
        "pages/events/filtering/ffilter/solution/0.html"
      , "pages/events/filtering/ffilter/solution/1.html"
      , "pages/events/filtering/ffilter/solution/2.html"
      , "pages/events/filtering/ffilter/solution/3.html"
      , "pages/events/filtering/ffilter/solution/4.html"
      ]
  in
    Exercise
      "ffilter"
