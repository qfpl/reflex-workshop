...
exMergeWith =
  let
    problem =
      Problem
        "pages/events/combining/mergeWith.html"
    ...
    solution =
      Solution [
        "pages/events/combining/mergeWith/solution/0.html"
      , "pages/events/combining/mergeWith/solution/1.html"
      , "pages/events/combining/mergeWith/solution/2.html"
      , "pages/events/combining/mergeWith/solution/3.html"
      , "pages/events/combining/mergeWith/solution/4.html"
      , "pages/events/combining/mergeWith/solution/5.html"
      ]
  in
    Exercise
      "mergeWith"
