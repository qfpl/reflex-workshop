...
exCounterText =
  let
    problem =
      Problem
      (static @ "pages/behaviors/querying/counterText.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/querying/counterText/solution/0.html"
      , static @ "pages/behaviors/querying/counterText/solution/1.html"
      , static @ "pages/behaviors/querying/counterText/solution/2.html"
      ]
  in
    Exercise
      "counterText"
