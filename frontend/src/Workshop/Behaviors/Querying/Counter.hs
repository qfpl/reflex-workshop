...
exCounter =
  let
    problem =
      Problem
        (static @ "pages/behaviors/querying/counter.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/querying/counter/solution/0.html"
      , static @ "pages/behaviors/querying/counter/solution/1.html"
      , static @ "pages/behaviors/querying/counter/solution/2.html"
      , static @ "pages/behaviors/querying/counter/solution/3.html"
      , static @ "pages/behaviors/querying/counter/solution/4.html"
      , static @ "pages/behaviors/querying/counter/solution/5.html"
      ]
  in
    Exercise
      "counter"
