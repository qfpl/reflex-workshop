...
exCounter =
  let
    problem =
      Problem
        (static @ "pages/behaviors/creating/counter.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/creating/counter/solution/0.html"
      , static @ "pages/behaviors/creating/counter/solution/1.html"
      , static @ "pages/behaviors/creating/counter/solution/2.html"
      ]
  in
    Exercise
      "counter"
