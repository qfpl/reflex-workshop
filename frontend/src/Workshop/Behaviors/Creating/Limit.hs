...
exLimit =
  let
    problem =
      Problem
        (static @ "pages/behaviors/creating/limit.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/creating/limit/solution/0.html"
      , static @ "pages/behaviors/creating/limit/solution/1.html"
      , static @ "pages/behaviors/creating/limit/solution/2.html"
      , static @ "pages/behaviors/creating/limit/solution/3.html"
      , static @ "pages/behaviors/creating/limit/solution/4.html"
      , static @ "pages/behaviors/creating/limit/solution/5.html"
      ]
  in
    Exercise
      "limit"
