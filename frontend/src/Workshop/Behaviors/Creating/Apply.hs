...
exApply =
  let
    problem =
      Problem
        (static @ "pages/behaviors/creating/apply.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/creating/apply/solution/0.html"
      , static @ "pages/behaviors/creating/apply/solution/1.html"
      , static @ "pages/behaviors/creating/apply/solution/2.html"
      , static @ "pages/behaviors/creating/apply/solution/3.html"
      , static @ "pages/behaviors/creating/apply/solution/4.html"
      , static @ "pages/behaviors/creating/apply/solution/5.html"
      , static @ "pages/behaviors/creating/apply/solution/6.html"
      ]
  in
    Exercise
      "apply"
