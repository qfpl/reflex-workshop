...
exText =
  let
    problem =
      Problem
        (static @ "pages/behaviors/creating/text.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/creating/text/solution/0.html"
      , static @ "pages/behaviors/creating/text/solution/1.html"
      , static @ "pages/behaviors/creating/text/solution/2.html"
      , static @ "pages/behaviors/creating/text/solution/3.html"
      ]
  in
    Exercise
      "text"
