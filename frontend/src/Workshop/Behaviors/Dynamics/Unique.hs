...
exUnique =
  let
    problem =
      Problem
        (static @ "pages/behaviors/dynamics/unique.html")
    ...
    solution =
      Solution [
        static @ "pages/behaviors/dynamics/unique/solution/0.html"
      , static @ "pages/behaviors/dynamics/unique/solution/1.html"
      , static @ "pages/behaviors/dynamics/unique/solution/2.html"
      ]
  in
    Exercise
      "unique"
