...
exFmapConst =
  let
    problem =
      Problem
        (static @ "pages/events/transforming/fmapConst.html")
    ...
    solution =
      Solution [
        static @ "pages/events/transforming/fmapConst/solution/0.html"
      , static @ "pages/events/transforming/fmapConst/solution/1.html"
      , static @ "pages/events/transforming/fmapConst/solution/2.html"
      , static @ "pages/events/transforming/fmapConst/solution/3.html"
      , static @ "pages/events/transforming/fmapConst/solution/4.html"
      ]
  in
    Exercise
      "fmapConst"
