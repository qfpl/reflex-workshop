...
exLeftmost =
  let
    problem =
      Problem
        (static @ "pages/events/combining/leftmost.html")
    ...
    solution =
      Solution [
        static @ "pages/events/combining/leftmost/solution/0.html"
      , static @ "pages/events/combining/leftmost/solution/1.html"
      , static @ "pages/events/combining/leftmost/solution/2.html"
      , static @ "pages/events/combining/leftmost/solution/3.html"
      , static @ "pages/events/combining/leftmost/solution/4.html"
      , static @ "pages/events/combining/leftmost/solution/5.html"
      , static @ "pages/events/combining/leftmost/solution/6.html"
      ]
  in
    Exercise
      "leftmost"
