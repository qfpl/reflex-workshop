...
import Solutions.Todo.Collections.Lists.Model.List
...
exModel =
  let
    problem =
      Problem
        (static @ "pages/collections/lists/model.html")
    ...
    solution =
      Solution [
        static @ "pages/collections/lists/model/solution/0.html"
      , static @ "pages/collections/lists/model/solution/1.html"
      , static @ "pages/collections/lists/model/solution/2.html"
      , static @ "pages/collections/lists/model/solution/3.html"
      ]
  in
    Exercise
      "model"
