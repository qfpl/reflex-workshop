...
exButton =
  let
    problem =
      Problem
        (static @ "pages/dom/elements/button.html")
    ...
    solution =
      Solution [
        static @ "pages/dom/elements/button/solution/0.html"
      , static @ "pages/dom/elements/button/solution/1.html"
      , static @ "pages/dom/elements/button/solution/2.html"
      , static @ "pages/dom/elements/button/solution/3.html"
      , static @ "pages/dom/elements/button/solution/4.html"
      ]
  in
    Exercise
      "button"
