...
exHigherOrder =
  let
    problem =
      Problem
        (static @ "pages/dom/switching/higherOrder.html")
    ...
    solution =
      Solution [
        static @ "pages/dom/switching/higherOrder/solution/0.html"
      , static @ "pages/dom/switching/higherOrder/solution/1.html"
      , static @ "pages/dom/switching/higherOrder/solution/2.html"
      , static @ "pages/dom/switching/higherOrder/solution/3.html"
      , static @ "pages/dom/switching/higherOrder/solution/4.html"
      , static @ "pages/dom/switching/higherOrder/solution/5.html"
      , static @ "pages/dom/switching/higherOrder/solution/6.html"
      ]
  in
    Exercise
      "higherOrder"
